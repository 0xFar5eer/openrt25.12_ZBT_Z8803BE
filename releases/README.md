...
```sh
git tag -a v25.12.2-4-zbt8803be -m "ZBT-Z8803BE OpenWrt v25.12.2-4-zbt8803be maintenance release"
git push origin 25.12
git push origin v25.12.2-4-zbt8803be

gh release create v25.12.2-4-zbt8803be \
  ...
  --latest \
  --title "ZBT-Z8803BE OpenWrt v25.12.2-4-zbt8803be maintenance release" \
