...
- **自定义 LuCI 应用:** About、Health、Temperature、Modem Events、Speedtest、WiFi Clients、Traffic Statistics 和 MLO 工具。
- **流量与 QoS 工具:** wrtbwmon 设备/域名流量视图，以及可手动启用调优的 QoSmate。
...
- SFP+ 已包含，但此处未做实体硬件验证。
- 当前分支基于 OpenWrt main 和 MediaTek 6.18 target kernel。
